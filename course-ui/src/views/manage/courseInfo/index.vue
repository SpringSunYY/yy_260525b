  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="courseInfoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
              <el-table-column label="课程编号" align="center" prop="id" v-if="columns[0].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="课程名称" align="center" prop="courseName" v-if="columns[2].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="课程描述" align="center" prop="courseDesc" v-if="columns[4].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="排序" align="center" prop="orderNum" v-if="columns[5].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="注册人数" align="center" prop="registerNum" v-if="columns[6].visible" :show-overflow-tooltip="true"/>
                <el-table-column label="点赞人数" align="center" prop="likeNum" v-if="columns[7].visible" :show-overflow-tooltip="true"/>
                ...
                <el-table-column label="老师" align="center" prop="userId" v-if="columns[9].visible" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="courseInfoRef" :model="form" :rules="rules" label-width="80px">
                        ...
                        <el-form-item label="封面" prop="courseCover">
                          <image-upload v-model="form.courseCover"/>
                        </el-form-item>
