<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="courseRegisterInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="老师" align="center" prop="teacherName" v-if="columns[3].visible"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="学生" align="center" prop="userName" v-if="columns[4].visible"
                       :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['manage:courseRegisterInfo:edit']">修改
          </el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['manage:courseRegisterInfo:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="courseRegisterInfoRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item v-if="form.id!=null" label="状态" prop="status">
...
import {
  ...
  delCourseRegisterInfo,
  getCourseRegisterInfo,
