...
public class CourseMaterialInfoEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param courseMaterialInfoEdit 编辑对象
     * @return CourseMaterialInfo
     */
    public static CourseMaterialInfo editToObj(CourseMaterialInfoEdit courseMaterialInfoEdit) {
        if (courseMaterialInfoEdit == null) {
            return null;
        }
        CourseMaterialInfo courseMaterialInfo = new CourseMaterialInfo();
        BeanUtils.copyProperties(courseMaterialInfoEdit, courseMaterialInfo);
        return courseMaterialInfo;
    }
}
